...
1. 先照 `docs/ai-install-intake.md` 詢問使用者要選哪一種產品模式：`skills-school` 全功能會員社群（類 Skool / School）或 `signal-brief` 出版訂閱通訊（類 Substack）。接著再問想建立哪種會員服務、需要哪些前台頁面、內容類型、會員功能、登入方式與通知通道。
2. 先確認 app 可以在本機跑起來。
